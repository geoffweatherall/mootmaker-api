...
See [testing-strategy.md](testing-strategy.md) for the overall testing approach for this repo (unit vs. acceptance tests, ephemeral environments, how Cognito verification codes are read in tests), and [mootmaker's testing-strategy.md](https://github.com/geoffweatherall/mootmaker/blob/main/testing-strategy.md) for how it fits the wider project.
