...
| [verify/](verify/) | Maven project with JUnit acceptance tests (`*IT.java`, run by failsafe) that exercise the **deployed** API over HTTP, resetting data via [mootmaker-admin-tools/database-reset](https://github.com/geoffweatherall/mootmaker-admin-tools/tree/main/database-reset) rather than a GraphQL mutation (see [Authentication in end-to-end tests](#authentication-in-end-to-end-tests)). |
