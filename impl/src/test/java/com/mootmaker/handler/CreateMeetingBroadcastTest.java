...
class CreateMeetingBroadcastTest {
  ...
  private static Map<String, Object> event(
      final String startTime, final String endTime, final String roomId) {
    ...
    return new HashMap<>(
        Map.of(
            "arguments",
            new HashMap<>(Map.of("meeting", meeting)),
            "identity",
