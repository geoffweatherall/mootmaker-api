...
class ResolverDispatchHandlerTest {
  ...
  void dispatchesToTheHandlerMatchingParentTypeNameAndFieldName() {
    ...
    final ResolverDispatchHandler dispatcher =
        new ResolverDispatchHandler(
            Map.of("Query.rooms", rooms, "Mutation.createMeeting", createMeeting));

    final Map<String, Object> event =
        Map.of("info", Map.of("parentTypeName", "Query", "fieldName", "rooms"));
  ...
  void rejectsAnUnregisteredRoutingKey() {
    final ResolverDispatchHandler dispatcher =
        new ResolverDispatchHandler(Map.of("Query.rooms", new RecordingHandler()));

    final Map<String, Object> event =
        Map.of("info", Map.of("parentTypeName", "Query", "fieldName", "people"));
