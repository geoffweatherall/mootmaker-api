 ...
 * touching DynamoDB at all - which is why it is now a pure function, and why the whole GSI could go.
 *
...
public final class RoomAvailability {
     ...
     */
    public static boolean isFree(final List<MeetingRecord> meetingsThatDay, final String roomId,
    ...
    public static boolean isFreeIgnoring(final List<MeetingRecord> meetingsThatDay, final String roomId,
            final LocalDateTime startTime, final LocalDateTime endTime, final String ignoredMeetingId) {
        return meetingsThatDay.stream()
    ...
    private static boolean overlaps(final MeetingRecord existing, final LocalDateTime startTime, final LocalDateTime endTime) {
