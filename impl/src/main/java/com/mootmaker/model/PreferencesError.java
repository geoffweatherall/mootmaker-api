 ...
 * here - there is no id, the caller simply has no Person of their own - and its sibling {@code
 * NameRequired} would be permanently unreachable in a preferences result.
 */
